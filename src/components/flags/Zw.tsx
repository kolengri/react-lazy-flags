...
const Zw = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g mask="url(#zw_svg__a)">
      ...
      <path
        fill="#ffda44"
        d="m148.5 260.2-43.2-15.3-3.4-31a16.7 16.7 0 1 0-32.5 7.6l-12 12.1h21.5c0 22.4-16.7 22.4-16.7 44.7l9.2 22.2h55.7l9.3-22.2a22.2 22.2 0 0 0 1.7-6.6c8-3.2 10.4-11.5 10.4-11.5"
      />
      <path
        fill="#333"
