...
const SvgCnXz = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <mask id="cn-xz_svg__a">
      <path fill="#fff" d="M0 0h512v512H0z" />
    </mask>
    <g mask="url(#cn-xz_svg__a)">
      ...
      <path
        fill="#ffda44"
        d="m256.2 256.1 63 63a89 89 0 1 0-126 0zm39 128-38.8 19.5-39.2-19.5a39 39 0 1 1 78 0"
      />
