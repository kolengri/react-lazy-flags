...
const Hr = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g mask="url(#hr_svg__a)">
      ...
      <path
        fill="#eee"
        d="M167 167v122.3a89 89 0 0 0 35.8 71.3l15.5-3.9 19.7 19.8a89 89 0 0 0 18 1.8 89 89 0 0 0 17.9-1.8l22.4-18.7 13 2.8a89 89 0 0 0 35.7-71.3V167z"
      />
      <path
        fill="#d80027"
