...
const EsPv = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g mask="url(#es-pv_svg__a)">
      ...
      <path
        fill="#496e2d"
        d="M0 0v47.2L208.8 256 0 464.8V512h47.2L256 303.2 464.8 512H512v-47.2L303.2 256 512 47.3V0h-47L256 208.8 47.2 0z"
      />
      <path
        fill="#eee"
